...
//! 3. Python bindings ([`python`], internal), built as a `cdylib` under the
//!    `python` feature and packaged with `maturin` into a single wheel that
//!    exposes the outram-park-backend API.
