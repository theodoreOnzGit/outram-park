...
class KovanDocument:
    ...
    markdown_body: str
    def __init__(self, id: str, slug: str, visibility: Visibility, document_type: DocumentType, title: str) -> None: ...
    @staticmethod
    def builder(id: str, slug: str, visibility: Visibility, document_type: DocumentType, title: str) -> KovanDocumentBuilder: ...
...
class KovanDocumentBuilder:
    ...
    def abstract_text(self, text: str) -> KovanDocumentBuilder: ...
    def year(self, year: int) -> KovanDocumentBuilder: ...
    def doi(self, doi: str) -> KovanDocumentBuilder: ...
    def journal(self, journal: str) -> KovanDocumentBuilder: ...
    def institution(self, institution: str) -> KovanDocumentBuilder: ...
    def publisher(self, publisher: str) -> KovanDocumentBuilder: ...
    def volume(self, volume: str) -> KovanDocumentBuilder: ...
    def pages(self, pages: str) -> KovanDocumentBuilder: ...
    def number(self, number: str) -> KovanDocumentBuilder: ...
    def keywords(self, keywords: list[str]) -> KovanDocumentBuilder: ...
    def tags(self, tags: list[str]) -> KovanDocumentBuilder: ...
    def source_url(self, url: str) -> KovanDocumentBuilder: ...
    def source_path(self, path: str) -> KovanDocumentBuilder: ...
    def source_sha256(self, sha256: str) -> KovanDocumentBuilder: ...
    ...
    def markdown_body(self, body: str) -> KovanDocumentBuilder: ...
