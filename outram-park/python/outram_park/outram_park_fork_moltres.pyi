...
class CirculatingFuelSolver:
    flux: list[outram_foam_basic_lib.VolScalarField]
    precursors: list[outram_foam_basic_lib.VolScalarField]
    k_eff: float
    def set_temperature(self, temperature: outram_foam_basic_lib.VolScalarField, t_ref: float) -> None: ...
...
class XsFields:
    ...
    def sigma_removal_at(self, temperature: outram_foam_basic_lib.VolScalarField, t_ref: float) -> list[outram_foam_basic_lib.VolScalarField]: ...
...
class PrecursorDrift:
    ...
    flow: outram_foam_basic_lib.SurfaceScalarField
    diffusion: float
    linear: outram_foam_basic_lib.SolverSettings
    def __init__(self, mesh: outram_foam_basic_lib.FvMesh, families: list[DelayedFamily], flow: outram_foam_basic_lib.SurfaceScalarField, diffusion: float, linear: outram_foam_basic_lib.SolverSettings) -> None: ...
    def solve_steady(self, fission_source: outram_foam_basic_lib.VolScalarField, k_eff: float) -> list[outram_foam_basic_lib.VolScalarField]: ...
    def step(self, previous: list[outram_foam_basic_lib.VolScalarField], fission_source: outram_foam_basic_lib.VolScalarField, k_eff: float, dt: float) -> list[outram_foam_basic_lib.VolScalarField]: ...
    def delayed_source(self, precursors: list[outram_foam_basic_lib.VolScalarField]) -> outram_foam_basic_lib.VolScalarField: ...
...
class RingMesh:
    ...
    def uniform_flux(self, speed: float) -> outram_foam_basic_lib.SurfaceScalarField: ...
...
class CoupledMsrSolver:
    ...
    def __init__(self, neutronics: CirculatingFuelSolver, thermal: SaltThermalModel, flow: outram_foam_basic_lib.SurfaceScalarField, target_power: float, t_ref: float, relaxation: float, max_picard_iterations: int, temperature_tolerance: float) -> None: ...

class CoupledReport:
    eigen: EigenReport
    temperature: outram_foam_basic_lib.VolScalarField
    heat_source: outram_foam_basic_lib.VolScalarField
    picard_iterations: int
    temperature_residual: float
    def __init__(self, eigen: EigenReport, temperature: outram_foam_basic_lib.VolScalarField, heat_source: outram_foam_basic_lib.VolScalarField, picard_iterations: int, temperature_residual: float) -> None: ...
...
class SaltThermalModel:
    ...
    def solve_steady(self, flow: outram_foam_basic_lib.SurfaceScalarField, heat_source: outram_foam_basic_lib.VolScalarField) -> tuple[outram_foam_basic_lib.VolScalarField, outram_foam_basic_lib.SolverPerformance]: ...
