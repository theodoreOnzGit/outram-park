...
|---|---|
| [`RESPONSIBLE_USE.md`](https://github.com/theodoreOnzGit/outram-park-backend/blob/develop/RESPONSIBLE_USE.md) | Intended and prohibited use, data scope, the V&V stage pipeline |
| [`DATA_POLICY.md`](https://github.com/theodoreOnzGit/outram-park-backend/blob/develop/DATA_POLICY.md) | What data may and may not be used or referenced, anywhere |
| [`AI_USAGE.md`](https://github.com/theodoreOnzGit/outram-park-backend/blob/develop/AI_USAGE.md) | Which AI systems the project uses, required human review, restricted inputs |
| [`RESEARCH_INTEGRITY_AND_PROVENANCE.md`](https://github.com/theodoreOnzGit/outram-park-backend/blob/develop/RESEARCH_INTEGRITY_AND_PROVENANCE.md) | Scientific and software provenance, licence and attribution compliance |
| [`VERIFICATION_AND_VALIDATION.md`](https://github.com/theodoreOnzGit/outram-park-backend/blob/develop/VERIFICATION_AND_VALIDATION.md) | The project's V&V philosophy and what "verified" and "validated" mean here |
...
- **Data scope.** Only open-source data, public literature data, and properly
  ...
  unpublished third-party data. See [`DATA_POLICY.md`](https://github.com/theodoreOnzGit/outram-park-backend/blob/develop/DATA_POLICY.md).
- **Intended use.** OUTRAM PARK is for education, research, capability building,
  ...
  purposes. See [`RESPONSIBLE_USE.md`](https://github.com/theodoreOnzGit/outram-park-backend/blob/develop/RESPONSIBLE_USE.md).
...
[`docs/ecosystem-naming.md`](https://github.com/theodoreOnzGit/outram-park-backend/blob/develop/docs/ecosystem-naming.md) and
[`docs/architecture.md`](https://github.com/theodoreOnzGit/outram-park-backend/blob/develop/docs/architecture.md) in `outram-park-backend`. The
...
intended-use limits in [`RESPONSIBLE_USE.md`](https://github.com/theodoreOnzGit/outram-park-backend/blob/develop/RESPONSIBLE_USE.md). It is not
...
[`DEVELOPER_HEALTH_WARNING.md`](https://github.com/theodoreOnzGit/outram-park-backend/blob/develop/DEVELOPER_HEALTH_WARNING.md) and enforces
...
and publication-disclosure wording — is in [`AI_USAGE.md`](https://github.com/theodoreOnzGit/outram-park-backend/blob/develop/AI_USAGE.md).
...
[`RESEARCH_INTEGRITY_AND_PROVENANCE.md`](https://github.com/theodoreOnzGit/outram-park-backend/blob/develop/RESEARCH_INTEGRITY_AND_PROVENANCE.md).
