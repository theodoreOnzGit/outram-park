...
\begin{frame}{Mission Briefing: Change Reactor Power}
    ...
    \begin{columns}
        ...
        \begin{column}{0.58\textwidth}
            ...
            The HTR-10 demonstration plant is operating stably at its rated
            thermal power of \textbf{10\,MWth}.
            ...
            \begin{alertblock}{Your Objective}
                Raise reactor thermal power from \textbf{10\,MWth} to
...
\begin{frame}{Safety Limit}
    ...
    That is fifty times rated power, so it is not a near miss. Reaching it
    means the excursion got away from you entirely.
...
\begin{frame}{The Challenge Begins}
    ...
    Who has the steady hand to take the reactor from 10\,MWth to
