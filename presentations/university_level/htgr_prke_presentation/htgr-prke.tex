...
\begin{frame}{Mission Briefing: Change Reactor Power}
    ...
    \begin{columns}
        ...
        \begin{column}{0.58\textwidth}
            ...
            The HTGR demonstration plant is operating at a stable condition.
            ...
            \begin{alertblock}{Your Objective}
                Increase reactor thermal power in a controlled manner and
                stabilise the plant near the instructor's target power.
            \end{alertblock}
...
\begin{frame}{Operational Constraints}
    ...
    \begin{block}{Rules}
        ...
        \begin{itemize}
            ...
            \item Approach the target without a large overshoot.
...
\begin{frame}{The Challenge Begins}
    ...
    Bring the reactor to the requested power and stabilise it.
