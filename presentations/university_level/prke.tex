...
\begin{frame}[allowframebreaks]{Advanced Control: Load Following Without Control Rods}
    ...
    \begin{itemize}
        \item \textbf{TRISO fuel:} Much higher thermal margins (\textgreater 1600°C) compared to traditional UO$_2$ 
			with zircalloy cladding (\textgreater 800°C, strong degradation via oxidation
