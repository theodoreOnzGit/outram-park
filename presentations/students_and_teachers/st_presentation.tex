...
\begin{frame}[allowframebreaks]{Acknowledgments}
    \begin{block}{Development of These Materials}
        This presentation was developed with assistance 
		from \textbf{Google's Gemini model} and \textbf{Claude Sonnet} via \textbf{NUS AI-Know}, the 
		National University of Singapore's trusted generative AI platform 
		\cite{aiknow2026prke,
		aiknow2026gemini}.
    \end{block}
