...
% --- NEW SLIDE 15: Experimental Natural Circulation Testing ---
% -- use ciet educational simulator
    ...
    \begin{columns}[T]
        \begin{column}{0.5\textwidth}
            \begin{figure}[H]
                ...
                \includegraphics[width=\textwidth, keepaspectratio]{ciet_simulator.png}
...
% --- Slide 16: Phenomenon #4: Materials Science (Final Correction) ---
\begin{frame}[allowframebreaks]{Phenomenon \#4: Materials Science - Forging the Unbreakable}
    \textbf{Concept:} The inside of a reactor is one of the most extreme environments humans have ever created: intense radiation that damages atomic structures, high temperatures, and high pressure.
    
    \vspace{1em}
    \textbf{The Safety Question:} What can we possibly build the reactor out of? How do we invent and test materials that can perform their job flawlessly for over 60 years without cracking, corroding, or becoming brittle?
    
    \vspace{1em}
    \begin{exampleblock}{An Example of Extreme Engineering: TRISO Fuel}
        \begin{columns}
            \begin{column}{0.65\textwidth}
                Advanced reactors like the \textbf{High-Temperature Gas-Cooled Reactor (HTGR)} and the \textbf{Fluoride-salt-cooled High-temperature Reactor (FHR)} use TRISO fuel.
                
                Each particle, the size of a poppy seed, contains a uranium kernel wrapped in multiple layers of incredibly durable ceramic. These layers act as a tiny, personal containment vessel, trapping radioactive products inside even at extreme temperatures up to 1600°C.
            \end{column}
