...
% --- Slide 13: Phenomenon #3: Heat Transfer (Revised) ---
...
% --- Slide 14: Phenomenon #4: Materials Science ---
    ...
    \begin{exampleblock}{An Example of Extreme Engineering: TRISO Fuel}
        \begin{columns}
            \begin{column}{0.65\textwidth}
                Advanced reactors like the FHR use TRISO fuel. Each particle, the size of a poppy seed, contains a uranium kernel wrapped in multiple layers of incredibly durable ceramic.
                
                These layers are designed to act as a tiny, personal containment vessel, trapping radioactive products inside even at temperatures hotter than lava (\textgreater 1600°C).
            \end{column}
            \begin{column}{0.35\textwidth}
                \centering
                % Placeholder for a TRISO image. You will need to find a 'triso_particle.png'
                % file or similar to make this appear.
